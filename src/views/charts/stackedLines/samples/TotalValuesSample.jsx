...
<StackedLinesChart data={data} totals xLabels />
`
...
export default function TotalValuesSample() {
  return <SampleCodeBlock title="Total Values" code={CODE} content={CONTENT} />
}
